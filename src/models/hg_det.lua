...
function createModel()
    ...
    local cnv1_ = nnlib.SpatialConvolution(opt.inputChanels,64,7,7,2,2,3,3)(inp)           -- 128
    ...
    for i = 1,opt.nStack do
        ...
        --for DistKLDiv
        local tmpOut_logsoftmax = nn.SpatialLogSoftMax()(tmpOut)
        
        --local tmpOut_log = nn.LogSoftMax()(tmpOut)
        table.insert(out,tmpOut_logsoftmax)
